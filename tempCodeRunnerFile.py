...
from PySide6.QtCore import QTimer, Qt, QPropertyAnimation, QEasingCurve, QObject, Property
from spotipy import Spotify
from spotipy.oauth2 import SpotifyOAuth
from PIL import Image

# 🔥 Credenciais de diva
CLIENT_ID = '7753952f21a14e3db81ecd0060587472'
CLIENT_SECRET = 'bb2e03c5a3d84fc39fcacbe09ae4bdbb'
...
class SpotifyApp(ColorWidget):
    def __init__(self):
        ...
        # AQUI tu bota o estilo babadeiro que eu te passei
        ...
        def load_icon(path):
            icon = QPixmap(path)
            return icon.scaled(30, 30, Qt.KeepAspectRatio, Qt.SmoothTransformation)

        try:
            play_icon = QIcon(load_icon("assets/play.png"))
            pause_icon = QIcon(load_icon("assets/pause.png"))
            next_icon = QIcon(load_icon("assets/next.png"))
            prev_icon = QIcon(load_icon("assets/prev.png"))
        ...
        self.color_timer.start(1000)  # 💨 Mais rápido bebê, 1 segundo trocando cor

        self.animation = QPropertyAnimation(self, b"color")
        self.animation.setDuration(800)  # 🔥 Transições mais rápidas
